...
exports.onPreBootstrap = async ({ reporter }) => {
  ...
  } else if (process.env.MONGODB_MIGRATIONS_CONNECTION_STRING.includes('127.0.0.1')) {
    console.info('MONGODB_MIGRATIONS_CONNECTION_STRING is set to localhost, skipping migrations.');
  } else {
